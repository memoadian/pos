        ...
        <div class="p-6 space-y-5">
            ...
            <div class="border-t border-slate-200 pt-5">
                ...
                <label class="flex items-start gap-3 cursor-pointer mb-4">
                    <input type="checkbox" name="auto_wholesale" value="1" {{ old('auto_wholesale', $product->auto_wholesale) ? 'checked' : '' }} class="mt-0.5 w-4 h-4 text-cyan-600 border-slate-300 rounded focus:ring-2 focus:ring-cyan-500 transition">
