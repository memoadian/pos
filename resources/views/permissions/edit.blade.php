...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl font-semibold text-slate-900">Editar Permiso</h1>
            <p class="text-sm text-slate-500 mt-1">Modifica la información del permiso</p>
        </div>
    </div>
        ...
        <div>
            ...
            <div class="flex gap-2">
                ...
                <input type="text"
                       ...
                       class="flex-1 px-4 py-2.5 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 outline-none transition @error('group') border-red-400 @enderror {{ old('group', $permission->group) ? 'hidden' : '' }}"
