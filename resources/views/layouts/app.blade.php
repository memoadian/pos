...
<head>
    ...
    {{-- La fuente de Google/bunny.net es solo estetica (hay fallback a
    system-ui); los iconos de bootstrap-icons se auto-hospedan via Vite
    (ver resources/css/app.css) porque el POS los necesita tambien sin
    internet. --}}
