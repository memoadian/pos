...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg border border-slate-200 p-4"><div class="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <label class="flex items-center gap-2 px-3 py-2 text-sm border border-slate-300 rounded-lg cursor-pointer"><input type="checkbox" id="lowStockFilter" class="w-4 h-4 text-cyan-600 border-slate-300 rounded focus:ring-2 focus:ring-cyan-500"><span class="text-slate-700">Solo stock bajo</span></label>
...
@section('scripts')
<script>
const filters = {department: document.getElementById('departmentFilter'), lowStock: document.getElementById('lowStockFilter'), search: document.getElementById('searchInput')};
let debounceTimer;
