        ...
        <div class="bg-white rounded-lg border border-slate-200 p-5">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('roles.show', $role) }}"
                   class="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-medium rounded-lg transition-colors">
                    <i class="bi bi-eye"></i>
                    <span>Ver</span>
                </a>
                <a href="{{ route('roles.edit', $role) }}"
                   class="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-emerald-100 hover:bg-emerald-200 text-emerald-700 text-sm font-medium rounded-lg transition-colors">
